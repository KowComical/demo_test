(() => {
  ...
  const STORAGE_KEY = "dice_3d_negative_review_v2_session";
  ...
  const I18N = {
    en: {
      documentTitle: "DICE-3D Negative Review v2",
      ...
      taskLine: "Review the new negative candidates; use Not sure whenever the difference is unclear.",
    ...
    zh: {
      documentTitle: "DICE-3D 新 Negative 筛选 v2",
      languageLabel: "语言",
      themeLabel: "配色",
      themeNeutral: "清爽",
      themeSage: "浅绿",
      themePaper: "纸感",
      pageTitle: "哪个更贴合语音？",
      taskLine: "筛选新生成的 negative；差异不清楚时请直接选择不确定。",
